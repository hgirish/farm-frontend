        ...
        <div className="flex items-center justify-center">
            ...
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"  action={formAction}>
                ...
                <div className="flex items-center justify-between">
                    <button className="bg-gray-900 hover:bg-gray-700 text-white w-full font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" 
                    type="submit">Save new car</button>
                </div>
